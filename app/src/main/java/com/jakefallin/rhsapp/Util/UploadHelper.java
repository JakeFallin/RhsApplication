...
public class UploadHelper {
    ...
    public class UploadComponentInfoTask extends AsyncTask<AppInfo, Integer, Boolean> {
        ...
        public void showProgress(Activity act) {
            ...
            mProgressDialog.setTitle("Progress Sample");
            mProgressDialog.setMessage("Sample");
        ...
        protected void onPreExecute() {
            if (!Network.isAvailiable(act)) {
                this.cancel(true);
                Snackbar.make(act.findViewById(android.R.id.content), "No Internet", Snackbar.LENGTH_SHORT).show();
            } else {
                showProgress(act);
            }
